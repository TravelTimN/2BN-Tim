$(document).ready(() => {
    ...
    let ul_hex6x = "<ul class='hexagons-6x'>";
    let ul_hex5x = "<ul class='hexagons-5x'>";

    // row 1
    let row1 = ul_hex6x;
    skillsRow1.map(skill => {
        row1 += "<li><div><img src='" + imgs_skills + skill.toLowerCase() +
            imgType + "' alt='" + skill + "' class='fadeIn' lazyload='on'><h1>" +
            skill + "</h1></div></li>";
    });
    row1 += "</ul>";
    ...
    skillsRow2.map(skill => {
        row2 += "<li><div><img src='" + imgs_skills + skill.toLowerCase() +
            imgType + "' alt='" + skill + "' class='fadeIn' lazyload='on'><h1>" +
            skill + "</h1></div></li>";
    });
    row2 += "</ul>";
    ...
    skillsRow3.map(skill => {
        row3 += "<li><div><img src='" + imgs_skills + skill.toLowerCase() +
            imgType + "' alt='" + skill + "' class='fadeIn' lazyload='on'><h1>" +
            skill + "</h1></div></li>";
    });
    row3 += "</ul>";
    ...
    skillsRow4.map(skill => {
        row4 += "<li><div><img src='" + imgs_skills + skill.toLowerCase() +
            imgType + "' alt='" + skill + "' class='fadeIn' lazyload='on'><h1>" +
            skill + "</h1></div></li>";
    });
    row4 += "</ul>";
    ...
    skillsRow5.map(skill => {
        row5 += "<li><div><img src='" + imgs_skills + skill.toLowerCase() +
            imgType + "' alt='" + skill + "' class='fadeIn' lazyload='on'><h1>" +
            skill + "</h1></div></li>";
    });
    row5 += "</ul>";
    ...
    $("#skills").append(row1, row2, row3, row4, row5);
